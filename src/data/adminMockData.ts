...
export interface MonthlyExchangeRate {
  ...
  rates: {
    ...
    'CNY/SGD': number;    // 1 CNY = 0.19 SGD
    'CNY/PHP': number;    // 1 CNY = 8.1 PHP
    'CNY/HKD': number;    // 1 CNY = 1.12 HKD
  };
...
export const enterprises: Enterprise[] = [
  ...
  {
    id: 'E005',
    name: 'SingPost Logistics',
    phone: '62345678',
    password: 'SingPost@2026',
    countryCode: '+65',
    country: '新加坡',
    currency: 'CNY',
    localCurrency: 'SGD',
...
export const adminOrders: AdminOrder[] = [
  ...
  // SingPost Logistics (新加坡)
  {
    orderId: 'LLI-20260322-501', supplierOrderId: 'LLM-SG-11001', supplierCode: 'LLM（新加坡）', supplierName: 'LLM（新加坡）',
    enterpriseId: 'E005', orderDate: '2026-03-22 09:00', pickupTime: '2026-03-22 09:30', country: '新加坡', vehicleType: 'Van',
    pickupAddress: 'Jurong East, Singapore', pickupContact: 'David Tan +65 6234 5678',
    dropoffAddress: 'Changi Business Park, Singapore', dropoffContact: 'Sarah Lim +65 6345 6789',
    driverInfo: 'SGW 1234 A / +65 9123 4567', status: '已完成',
    lliAmount: 95.00, lliFeeBreakdown: { baseFare: 40, distanceFee: 30, serviceFee: 10, surcharge: 8, tax: 7.00, discount: 0, total: 95.00 },
    llmAmount: 82.00, llmFeeBreakdown: { baseFare: 35, distanceFee: 26, serviceFee: 9, surcharge: 7, tax: 5.00, discount: 0, total: 82.00 },
    currency: 'SGD',
  },
  {
    orderId: 'LLI-20260324-502', supplierOrderId: 'LLM-SG-11002', supplierCode: 'LLM（新加坡）', supplierName: 'LLM（新加坡）',
    enterpriseId: 'E005', orderDate: '2026-03-24 14:00', pickupTime: '2026-03-24 14:30', country: '新加坡', vehicleType: 'Small Truck',
    pickupAddress: 'Tuas, Singapore', pickupContact: 'Jason Wong +65 6234 5678',
    dropoffAddress: 'Kallang Sector, Singapore', dropoffContact: 'Michelle +65 6456 7890',
    driverInfo: '-', status: '正在呼叫司机',
    lliAmount: 138.00, lliFeeBreakdown: { baseFare: 55, distanceFee: 48, serviceFee: 15, surcharge: 12, tax: 8.00, discount: 0, total: 138.00 },
    llmAmount: 120.00, llmFeeBreakdown: { baseFare: 48, distanceFee: 42, serviceFee: 13, surcharge: 11, tax: 6.00, discount: 0, total: 120.00 },
    currency: 'SGD',
  },
  // LBC Express Philippines (菲律宾)
  {
    orderId: 'LLI-20260321-601', supplierOrderId: 'LLM-PH-22001', supplierCode: 'LLM（菲律宾）', supplierName: 'LLM（菲律宾）',
    enterpriseId: 'E006', orderDate: '2026-03-21 10:00', pickupTime: '2026-03-21 10:30', country: '菲律宾', vehicleType: 'Van',
    pickupAddress: 'Makati CBD, Metro Manila', pickupContact: 'Jose Santos +63 917 123 4567',
    dropoffAddress: 'Pasig City, Metro Manila', dropoffContact: 'Maria Reyes +63 918 234 5678',
    driverInfo: 'ABC 1234 / +63 919 345 6789', status: '已完成',
    lliAmount: 2850.00, lliFeeBreakdown: { baseFare: 1200, distanceFee: 900, serviceFee: 350, surcharge: 200, tax: 200.00, discount: 0, total: 2850.00 },
    llmAmount: 2480.00, llmFeeBreakdown: { baseFare: 1050, distanceFee: 780, serviceFee: 300, surcharge: 175, tax: 175.00, discount: 0, total: 2480.00 },
    currency: 'PHP',
  },
  // 顺丰速运（香港）
  {
    orderId: 'LLI-20260323-701', supplierOrderId: 'LLM-HK-33001', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-23 08:30', pickupTime: '2026-03-23 09:00', country: '香港', vehicleType: 'Van',
    pickupAddress: 'Kwun Tong, Kowloon', pickupContact: 'Tommy Chan +852 2345 6789',
    dropoffAddress: 'Tsuen Wan, New Territories', dropoffContact: 'Helen Ng +852 3456 7890',
    driverInfo: 'HK 1234 / +852 9123 4567', status: '已完成',
    lliAmount: 620.00, lliFeeBreakdown: { baseFare: 250, distanceFee: 200, serviceFee: 80, surcharge: 50, tax: 40.00, discount: 0, total: 620.00 },
    llmAmount: 540.00, llmFeeBreakdown: { baseFare: 215, distanceFee: 175, serviceFee: 70, surcharge: 45, tax: 35.00, discount: 0, total: 540.00 },
    currency: 'HKD',
  },
  {
    orderId: 'LLI-20260324-702', supplierOrderId: 'LLM-HK-33002', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-24 11:00', pickupTime: '2026-03-24 11:30', country: '香港', vehicleType: 'Pickup Truck',
    pickupAddress: 'Sha Tin, New Territories', pickupContact: 'Kevin Lau +852 2345 6789',
    dropoffAddress: 'Kowloon Bay, Kowloon', dropoffContact: 'Amy Cheung +852 4567 8901',
    driverInfo: 'HK 5678 / +852 9234 5678', status: '配送中',
    lliAmount: 480.00, lliFeeBreakdown: { baseFare: 190, distanceFee: 160, serviceFee: 60, surcharge: 40, tax: 30.00, discount: 0, total: 480.00 },
    llmAmount: 415.00, llmFeeBreakdown: { baseFare: 165, distanceFee: 140, serviceFee: 52, surcharge: 35, tax: 23.00, discount: 0, total: 415.00 },
    currency: 'HKD',
  },
  // 订单状态示例（重新呼叫司机 / 已取消 各种细分场景）
  {
    orderId: 'LLI-20260325-901', supplierOrderId: 'LLM-HK-33003', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-25 09:15', pickupTime: '2026-03-25 09:45', country: '香港', vehicleType: 'Van',
    pickupAddress: 'Mong Kok, Kowloon', pickupContact: 'Jason Ho +852 2345 6789',
    dropoffAddress: 'Central, Hong Kong Island', dropoffContact: 'Wendy Lo +852 5678 9012',
    driverInfo: '-', status: '重新呼叫司机',
    lliAmount: 0, lliFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    llmAmount: 0, llmFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    currency: 'HKD',
  },
  {
    orderId: 'LLI-20260325-902', supplierOrderId: 'LLM-HK-33004', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-25 10:30', pickupTime: '2026-03-25 11:00', country: '香港', vehicleType: 'Pickup Truck',
    pickupAddress: 'Tai Po, New Territories', pickupContact: 'Peter Yip +852 2345 6789',
    dropoffAddress: 'Sai Kung, New Territories', dropoffContact: 'Carrie Fung +852 6789 0123',
    driverInfo: '-', status: '已取消（司机连续拒绝）',
    lliAmount: 0, lliFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    llmAmount: 0, llmFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    currency: 'HKD',
  },
  {
    orderId: 'LLI-20260325-903', supplierOrderId: 'LLM-HK-33005', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-25 13:00', pickupTime: '2026-03-25 13:30', country: '香港', vehicleType: '4-Door Car',
    pickupAddress: 'North Point, Hong Kong Island', pickupContact: 'Simon Tsang +852 2345 6789',
    dropoffAddress: 'Aberdeen, Hong Kong Island', dropoffContact: 'Fiona Lam +852 7890 1234',
    driverInfo: '-', status: '已取消（超时）',
    lliAmount: 0, lliFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    llmAmount: 0, llmFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    currency: 'HKD',
  },
  {
    orderId: 'LLI-20260325-904', supplierOrderId: 'LLM-HK-33006', supplierCode: 'LLM（香港）', supplierName: 'LLM（香港）',
    enterpriseId: 'E007', orderDate: '2026-03-25 15:20', pickupTime: '2026-03-25 15:50', country: '香港', vehicleType: 'Motorcycle',
    pickupAddress: 'Causeway Bay, Hong Kong Island', pickupContact: 'Alan Chow +852 2345 6789',
    dropoffAddress: 'Wan Chai, Hong Kong Island', dropoffContact: 'Grace Yeung +852 8901 2345',
    driverInfo: '-', status: '已取消（用户取消）',
    lliAmount: 0, lliFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    llmAmount: 0, llmFeeBreakdown: { baseFare: 0, distanceFee: 0, serviceFee: 0, surcharge: 0, tax: 0, discount: 0, total: 0 },
    currency: 'HKD',
  },
